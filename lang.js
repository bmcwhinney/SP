...
(function() {
    const translations = {
        en: {
            ...
            about_sara_bio: 'Sara is a systemic therapist with over ten years\' experience supporting individuals, couples, and families. She has facilitated many Family Constellations workshops, creating a safe, grounded space where insight, reflection, and growth can naturally emerge.',
            about_sara_bespoke: 'Sara is a systemic therapist with over ten years\' experience facilitating Family Constellations workshops. She brings warmth, presence, and clarity to every session, creating a space where participants feel safe to explore, reflect, and discover.',
            ...
            fc_what_highlight: '1:1 sessions are approximately 2 hours in length.',
            ...
            b_theme_p1: 'Sometimes a group comes together to explore something meaningful: a shared question, a challenge, or a theme that feels alive. These bespoke Systemic and Family Constellations workshops support that kind of inquiry, whether the group already exists or is formed specifically for the work.',
            b_theme_p2: 'A workshop can be arranged for an existing group, team, or community, or an individual within a company or organisation can commission a workshop, in which case Sara can gather an external group to participate.',
            b_theme_p3: 'Each workshop is shaped around the theme or question the group brings. For example:',
            b_example1_title: 'Honouring Our Ancestors, Envisioning the Past',
            b_example1_p: 'For the 50th anniversary of the Association of Family Therapy (AFT), a group explored this theme through a systemic constellations lens.',
            b_example2_title: 'Our Relationship with Money',
            b_example2_p: 'The Bitcoin community explored personal and collective relationships with money.',
            b_theme_p4: 'These examples show the range of inquiry possible, but each workshop is tailored to the group and the question they bring.',
        ...
        de: {
            ...
            about_sara_bio: 'Sara ist systemische Therapeutin mit über zehn Jahren Erfahrung in der Arbeit mit Einzelpersonen, Paaren und Familien. Sie hat viele Familienaufstellungs-Workshops geleitet und schafft einen sicheren, geerdeten Raum, in dem Einsicht, Reflexion und Wachstum natürlich entstehen können.',
            about_sara_bespoke: 'Sara ist systemische Therapeutin mit über zehn Jahren Erfahrung in der Leitung von Familienaufstellungs-Workshops. Sie bringt Wärme, Präsenz und Klarheit in jede Sitzung und schafft einen Raum, in dem sich Teilnehmende sicher fühlen, zu erkunden, zu reflektieren und zu entdecken.',
            ...
            fc_what_highlight: '1:1-Sitzungen dauern etwa 2 Stunden.',
            ...
            b_theme_p1: 'Manchmal kommt eine Gruppe zusammen, um etwas Bedeutsames zu erkunden: eine gemeinsame Frage, eine Herausforderung oder ein Thema, das lebendig wirkt. Diese maßgeschneiderten Systemischen und Familienaufstellungs-Workshops unterstützen diese Art der Erkundung, ob die Gruppe bereits existiert oder speziell für die Arbeit gebildet wird.',
            b_theme_p2: 'Ein Workshop kann für eine bestehende Gruppe, ein Team oder eine Gemeinschaft arrangiert werden, oder eine Einzelperson innerhalb eines Unternehmens oder einer Organisation kann einen Workshop beauftragen; in diesem Fall kann Sara eine externe Gruppe zur Teilnahme zusammenstellen.',
            b_theme_p3: 'Jeder Workshop wird um das Thema oder die Frage geformt, die die Gruppe mitbringt. Zum Beispiel:',
            b_example1_title: 'Unsere Vorfahren ehren, die Vergangenheit neu sehen',
            b_example1_p: 'Zum 50. Jubiläum der Association of Family Therapy (AFT) erkundete eine Gruppe dieses Thema durch die Linse systemischer Aufstellungen.',
            b_example2_title: 'Unsere Beziehung zum Geld',
            b_example2_p: 'Die Bitcoin-Community erkundete persönliche und kollektive Beziehungen zum Geld.',
            b_theme_p4: 'Diese Beispiele zeigen die Bandbreite möglicher Erkundungen, aber jeder Workshop ist auf die Gruppe und ihre Frage zugeschnitten.',
